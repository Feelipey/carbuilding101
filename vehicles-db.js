...
const PARTS_BY_PLATFORM = {
  ...
  // ── TOYOTA GR SUPRA (B58) ────────────────────────────────
  "B58": [
    {id:1,name:'Cold Air Intake',brand:'AEM / Eventuri',cat:'engine',icon:'🌬️',hp:'+8–12 whp',hpNum:10,diff:'Easy',diffC:'green',price:260,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:95,desc:'Direct-fit B58 intake. 2–3 hr DIY.',amazon:'https://www.amazon.com/s?k=cold+air+intake+toyota+supra+b58',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+b58+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Stage 2 ECU Tune',brand:'BM3 / Wedge Performance',cat:'engine',icon:'💻',hp:'+45–65 whp',hpNum:55,diff:'Software only',diffC:'blue',price:600,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:92,desc:'Unlocks full combo gains. E30/E50 flex maps.',amazon:'https://www.amazon.com/s?k=toyota+supra+ecu+tune+bm3',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+ecu+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=stage+2+ecu+tune'},
    {id:3,name:'Catless Downpipe',brand:'VRSF / BM3',cat:'exhaust',icon:'⬇️',hp:'+20–28 whp',hpNum:24,diff:'Moderate',diffC:'amber',price:420,tune:'Strongly recommended',compat:'warn',badge:'⚠ TUNE NEEDED',pop:88,desc:'Tune strongly recommended on B58.',amazon:'https://www.amazon.com/s?k=toyota+supra+downpipe',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+catless+downpipe',rockauto:'https://www.rockauto.com/en/partsearch/?query=catless+downpipe'},
    {id:4,name:'Catback Exhaust',brand:'Akrapovič / Remus',cat:'exhaust',icon:'💨',hp:'+12–18 whp',hpNum:15,diff:'Easy',diffC:'green',price:1100,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Significant sound. Valved options available.',amazon:'https://www.amazon.com/s?k=toyota+supra+catback+exhaust',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:5,name:'Intercooler Upgrade',brand:'Wagner / Mishimoto',cat:'engine',icon:'❄️',hp:'+8–15 whp',hpNum:12,diff:'Moderate',diffC:'amber',price:650,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:82,desc:'Required before turbo upgrade. Kills heat soak.',amazon:'https://www.amazon.com/s?k=supra+b58+intercooler',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+intercooler',rockauto:'https://www.rockauto.com/en/partsearch/?query=intercooler+upgrade'},
    {id:6,name:'Turbo Upgrade (Pure Stage 2)',brand:'Pure Turbos / Vargas',cat:'engine',icon:'🌀',hp:'+120–180 whp',hpNum:150,diff:'Hard',diffC:'red',price:3200,tune:'Required',compat:'req',badge:'SUPPORTING MODS REQ.',pop:75,desc:'Full supporting mods needed. 500+ whp capable.',amazon:'https://www.amazon.com/s?k=supra+b58+turbo+upgrade',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+turbo+upgrade',rockauto:'https://www.rockauto.com/en/partsearch/?query=turbo+upgrade+pure+stage+2'},
    {id:7,name:'Coilover Kit',brand:'BC Racing / KW V3',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1400,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:89,desc:'Full height + damper adjustability.',amazon:'https://www.amazon.com/s?k=toyota+supra+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+supra+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
    {id:8,name:'Big Brake Kit',brand:'StopTech / Brembo',cat:'brakes',icon:'🛑',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:2200,tune:'Check wheel clearance',compat:'warn',badge:'⚠ CHECK WHEEL CLR',pop:72,desc:'6-piston front BBK.',amazon:'https://www.amazon.com/s?k=supra+big+brake+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+big+brake+kit',rockauto:'https://www.rockauto.com/en/partsearch/?query=big+brake+kit'},
    {id:9,name:'Forged Wheels 18"',brand:'Volk TE37 / HRE',cat:'wheels',icon:'⭕',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:2800,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Full forged. Check offset for your fenders.',amazon:'https://www.amazon.com/s?k=18+inch+forged+wheels+supra',ebay:'https://www.ebay.com/sch/i.html?_nkw=volk+te37+18+inch',rockauto:'https://www.rockauto.com/en/partsearch/?query=forged+wheels+18'},
    {id:10,name:'Rear Wing (Swan Neck)',brand:'APR / Voltex',cat:'aero',icon:'🦢',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:680,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:74,desc:'High-downforce adjustable swan neck mount.',amazon:'https://www.amazon.com/s?k=toyota+supra+rear+wing',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+rear+wing',rockauto:'https://www.rockauto.com/en/partsearch/?query=rear+wing+swan+neck'},
    {id:11,name:'Flex Fuel Kit',brand:'EcuTek / BM3',cat:'engine',icon:'⛽',hp:'+20–30 whp',hpNum:25,diff:'Moderate',diffC:'amber',price:450,tune:'Required',compat:'req',badge:'REQUIRES TUNE',pop:77,desc:'Run E30–E50. Major gains paired with tune.',amazon:'https://www.amazon.com/s?k=supra+flex+fuel+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+flex+fuel',rockauto:'https://www.rockauto.com/en/partsearch/?query=flex+fuel+kit'},
    {id:12,name:'Sway Bar Set',brand:'Eibach / Whiteline',cat:'suspension',icon:'↔️',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:380,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:70,desc:'Front + rear. Reduces body roll significantly.',amazon:'https://www.amazon.com/s?k=toyota+supra+sway+bars',ebay:'https://www.ebay.com/sch/i.html?_nkw=supra+sway+bars',rockauto:'https://www.rockauto.com/en/partsearch/?query=sway+bar+set'},
  ],

  // ── TOYOTA TACOMA (2GR-FKS / 2TR-FE) ───────────────────
  "2GR-FKS / 2TR-FE": [
    {id:1,name:'Cold Air Intake',brand:'AEM / K&N / Injen',cat:'engine',icon:'🌬️',hp:'+5–10 whp',hpNum:7,diff:'Easy',diffC:'green',price:180,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:94,desc:'Bolt-on intake for 3.5L V6 or 2.7L 4-cyl. 1–2 hr install.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+cold+air+intake+3.5',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tacoma+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Suspension Lift Kit (2–3")',brand:'Bilstein / Old Man Emu / Fox',cat:'suspension',icon:'⬆️',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:650,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:96,desc:'Most popular Tacoma mod. Fits 33" tires with 2" lift.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+lift+kit+2+inch',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tacoma+lift+kit',rockauto:'https://www.rockauto.com/en/partsearch/?query=suspension+lift+kit+23'},
    {id:3,name:'Lift Kit (4–6") with UCAs',brand:'Total Chaos / SCS / ReadyLift',cat:'suspension',icon:'🏔️',hp:'N/A',hpNum:0,diff:'Hard',diffC:'red',price:2800,tune:'Alignment + CV angles req.',compat:'warn',badge:'⚠ REQUIRES UCAs',pop:85,desc:'Requires upper control arms. Fits 35–37" tires.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+4+inch+lift+kit+uca',ebay:'https://www.ebay.com/sch/i.html?_nkw=tacoma+4+inch+lift+uca',rockauto:'https://www.rockauto.com/en/partsearch/?query=lift+kit+46+with+ucas'},
    {id:4,name:'Catback Exhaust',brand:'Borla / MagnaFlow / Gibson',cat:'exhaust',icon:'💨',hp:'+8–15 whp',hpNum:11,diff:'Easy',diffC:'green',price:480,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Improved sound and slight HP gain on 3.5 V6.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+catback+exhaust+3.5',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tacoma+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:5,name:'Skid Plate Set',brand:'SCS / Cali Raised / NNDA',cat:'aero',icon:'🛡️',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:320,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:92,desc:'Full underbody protection. Engine, transfer case, fuel tank.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+skid+plate',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tacoma+skid+plate',rockauto:'https://www.rockauto.com/en/partsearch/?query=skid+plate+set'},
    {id:6,name:'All-Terrain Tires (33")',brand:'BFG KO2 / Falken WildPeak',cat:'wheels',icon:'🏁',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1100,tune:'Not required',compat:'warn',badge:'⚠ CHECK LIFT HEIGHT',pop:95,desc:'Most popular Tacoma tire size. Need 2"+ lift for fitment.',amazon:'https://www.amazon.com/s?k=33+inch+all+terrain+tires+tacoma',ebay:'https://www.ebay.com/sch/i.html?_nkw=33+inch+all+terrain+tires',rockauto:'https://www.rockauto.com/en/partsearch/?query=allterrain+tires+33'},
    {id:7,name:'Mud-Terrain Tires (35")',brand:'Mickey Thompson / Nitto Ridge Grappler',cat:'wheels',icon:'🦏',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1400,tune:'Not required',compat:'warn',badge:'⚠ NEEDS 4"+ LIFT',pop:82,desc:'Aggressive tread. Expect 1–2 mpg drop.',amazon:'https://www.amazon.com/s?k=35+inch+mud+terrain+tires+tacoma',ebay:'https://www.ebay.com/sch/i.html?_nkw=35+inch+mud+terrain+tires',rockauto:'https://www.rockauto.com/en/partsearch/?query=mudterrain+tires+35'},
    {id:8,name:'Method / TRD Pro Wheels',brand:'Method Race Wheels / SCS',cat:'wheels',icon:'⭕',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1600,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'6x139.7 bolt pattern. 0 to +15 offset for flush fitment.',amazon:'https://www.amazon.com/s?k=method+wheels+tacoma+6x139',ebay:'https://www.ebay.com/sch/i.html?_nkw=method+race+wheels+6x139+tacoma',rockauto:'https://www.rockauto.com/en/partsearch/?query=method+trd+pro+wheels'},
    {id:9,name:'Front Bumper (Aftermarket)',brand:'Demello / Relentless / Icon',cat:'aero',icon:'💥',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1200,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:80,desc:'Steel or aluminum. Better approach angle + recovery mounts.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+front+bumper+aftermarket',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tacoma+steel+front+bumper',rockauto:'https://www.rockauto.com/en/partsearch/?query=front+bumper+aftermarket'},
    {id:10,name:'Snorkel Kit',brand:'Safari / ARB / TJM',cat:'engine',icon:'🌊',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:360,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:68,desc:'Air intake relocation for water crossings up to door height.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+snorkel+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tacoma+snorkel',rockauto:'https://www.rockauto.com/en/partsearch/?query=snorkel+kit'},
    {id:11,name:'ECU / PCM Tune',brand:'ApexPro / Reaper Tuning',cat:'engine',icon:'💻',hp:'+15–25 whp',hpNum:20,diff:'Software only',diffC:'blue',price:350,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:72,desc:'Custom tune for V6 Tacoma. Throttle + transmission mapping.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tacoma+v6+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=ecu+pcm+tune'},
    {id:12,name:'Long Travel Suspension',brand:'Total Chaos / Icon',cat:'suspension',icon:'🔧',hp:'N/A',hpNum:0,diff:'Hard',diffC:'red',price:5500,tune:'Full alignment + geometry req.',compat:'req',badge:'PROFESSIONAL INSTALL',pop:60,desc:'Prerunner-spec suspension. 10"+ travel.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+long+travel+suspension',ebay:'https://www.ebay.com/sch/i.html?_nkw=tacoma+long+travel',rockauto:'https://www.rockauto.com/en/partsearch/?query=long+travel+suspension'},
    {id:13,name:'Differential Locker (ARB)',brand:'ARB Air Locker',cat:'suspension',icon:'🔒',hp:'N/A',hpNum:0,diff:'Hard',diffC:'red',price:900,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:74,desc:'Front or rear air locker. Best for rock crawling.',amazon:'https://www.amazon.com/s?k=arb+air+locker+tacoma',ebay:'https://www.ebay.com/sch/i.html?_nkw=arb+locker+tacoma',rockauto:'https://www.rockauto.com/en/partsearch/?query=differential+locker+arb'},
    {id:14,name:'Performance Brake Pads',brand:'Hawk / EBC',cat:'brakes',icon:'🔴',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:120,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:78,desc:'Improved bite. Especially useful with larger/heavier tires.',amazon:'https://www.amazon.com/s?k=toyota+tacoma+performance+brake+pads',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tacoma+brake+pads',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+brake+pads'},
  ],

  // ── TOYOTA TUNDRA (3UR-FE) ───────────────────────────────
  "3UR-FE / V35A": [
    {id:1,name:'Cold Air Intake',brand:'K&N / AEM / Banks',cat:'engine',icon:'🌬️',hp:'+10–18 whp',hpNum:14,diff:'Easy',diffC:'green',price:280,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Direct-fit intake for 5.7L V8. Notable gains.',amazon:'https://www.amazon.com/s?k=toyota+tundra+cold+air+intake+5.7',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tundra+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Lift Kit (3–4")',brand:'Rough Country / Bilstein / Icon',cat:'suspension',icon:'⬆️',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:850,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:93,desc:'Popular truck mod. Fits 33–35" tires.',amazon:'https://www.amazon.com/s?k=toyota+tundra+lift+kit+3+inch',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tundra+lift+kit',rockauto:'https://www.rockauto.com/en/partsearch/?query=lift+kit+34'},
    {id:3,name:'Catback Exhaust',brand:'MagnaFlow / Borla / Gibson',cat:'exhaust',icon:'💨',hp:'+12–20 whp',hpNum:16,diff:'Easy',diffC:'green',price:600,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:86,desc:'Deep V8 tone. Dual exit or single side.',amazon:'https://www.amazon.com/s?k=toyota+tundra+catback+exhaust+5.7',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tundra+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:4,name:'All-Terrain Tires (35")',brand:'BFG KO2 / Falken WildPeak',cat:'wheels',icon:'🏁',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1400,tune:'Not required',compat:'warn',badge:'⚠ CHECK LIFT HEIGHT',pop:92,desc:'35s fit best with 3"+ lift. Re-gear recommended at 35".',amazon:'https://www.amazon.com/s?k=35+inch+all+terrain+tires+tundra',ebay:'https://www.ebay.com/sch/i.html?_nkw=35+inch+all+terrain+tundra',rockauto:'https://www.rockauto.com/en/partsearch/?query=allterrain+tires+35'},
    {id:5,name:'Throttle Body Spacer',brand:'Billet Specialties / Airaid',cat:'engine',icon:'⚙️',hp:'+5–8 whp',hpNum:6,diff:'Easy',diffC:'green',price:90,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:65,desc:'Cheap bolt-on for V8. Minor gains but popular.',amazon:'https://www.amazon.com/s?k=toyota+tundra+throttle+body+spacer',ebay:'https://www.ebay.com/sch/i.html?_nkw=tundra+throttle+body+spacer',rockauto:'https://www.rockauto.com/en/partsearch/?query=throttle+body+spacer'},
    {id:6,name:'Performance Tune',brand:'ApexPro / Banks iDash',cat:'engine',icon:'💻',hp:'+20–35 whp',hpNum:28,diff:'Software only',diffC:'blue',price:400,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:75,desc:'Custom tune for 5.7 V8. Transmission mapping included.',amazon:'https://www.amazon.com/s?k=toyota+tundra+performance+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tundra+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+tune'},
    {id:7,name:'Aftermarket Wheels 18"',brand:'Method / Fuel / XD',cat:'wheels',icon:'⭕',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1800,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'5x150 bolt pattern (2007-2021). Wide variety available.',amazon:'https://www.amazon.com/s?k=toyota+tundra+wheels+5x150',ebay:'https://www.ebay.com/sch/i.html?_nkw=tundra+wheels+5x150',rockauto:'https://www.rockauto.com/en/partsearch/?query=aftermarket+wheels+18'},
    {id:8,name:'Skid Plate Set',brand:'SCS / Cali Raised',cat:'aero',icon:'🛡️',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:380,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:72,desc:'Engine + transfer case protection.',amazon:'https://www.amazon.com/s?k=toyota+tundra+skid+plate',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+tundra+skid+plate',rockauto:'https://www.rockauto.com/en/partsearch/?query=skid+plate+set'},
  ],

  // ── FORD F-150 (EcoBoost / Coyote) ──────────────────────
  "EcoBoost / Coyote": [
    {id:1,name:'Cold Air Intake',brand:'K&N / Airaid / Roush',cat:'engine',icon:'🌬️',hp:'+10–18 whp',hpNum:14,diff:'Easy',diffC:'green',price:280,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:92,desc:'Works on all F-150 engines. Notable gains on 3.5 EcoBoost.',amazon:'https://www.amazon.com/s?k=ford+f150+cold+air+intake+ecoboost',ebay:'https://www.ebay.com/sch/i.html?_nkw=ford+f150+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Performance Tune (EcoBoost)',brand:'VMP / Lund Racing / SCT',cat:'engine',icon:'💻',hp:'+50–80 whp',hpNum:65,diff:'Software only',diffC:'blue',price:650,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Massive gains on 3.5 EcoBoost. 93 oct or E30 maps.',amazon:'https://www.amazon.com/s?k=ford+f150+ecoboost+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=ford+f150+ecoboost+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+tune+ecoboost'},
    {id:3,name:'Catback Exhaust',brand:'Borla / MagnaFlow / Roush',cat:'exhaust',icon:'💨',hp:'+12–22 whp',hpNum:17,diff:'Easy',diffC:'green',price:750,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Dual exit or side-exit. Aggressive tone on V8.',amazon:'https://www.amazon.com/s?k=ford+f150+catback+exhaust',ebay:'https://www.ebay.com/sch/i.html?_nkw=ford+f150+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:4,name:'Lift Kit (3–4")',brand:'Rough Country / BDS / Superlift',cat:'suspension',icon:'⬆️',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:900,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:93,desc:'Fits 33–35" tires. IFS-specific kits available.',amazon:'https://www.amazon.com/s?k=ford+f150+3+inch+lift+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=ford+f150+lift+kit',rockauto:'https://www.rockauto.com/en/partsearch/?query=lift+kit+34'},
    {id:5,name:'Intercooler Upgrade (EcoBoost)',brand:'Mishimoto / Perrin',cat:'engine',icon:'❄️',hp:'+15–25 whp',hpNum:20,diff:'Moderate',diffC:'amber',price:550,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:78,desc:'Critical on 3.5 EcoBoost for sustained power in heat.',amazon:'https://www.amazon.com/s?k=ford+f150+ecoboost+intercooler',ebay:'https://www.ebay.com/sch/i.html?_nkw=f150+ecoboost+intercooler',rockauto:'https://www.rockauto.com/en/partsearch/?query=intercooler+upgrade+ecoboost'},
    {id:6,name:'All-Terrain Tires (35")',brand:'BFG KO2 / Nitto Terra Grappler',cat:'wheels',icon:'🏁',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1400,tune:'Not required',compat:'warn',badge:'⚠ CHECK LIFT HEIGHT',pop:94,desc:'35s on F-150 with 2.5"+ lift. May need trimming.',amazon:'https://www.amazon.com/s?k=35+inch+all+terrain+tires+f150',ebay:'https://www.ebay.com/sch/i.html?_nkw=35+inch+all+terrain+f150',rockauto:'https://www.rockauto.com/en/partsearch/?query=allterrain+tires+35'},
    {id:7,name:'Wheels (20" Forged)',brand:'Fuel / Method / KMC',cat:'wheels',icon:'⭕',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:2000,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:85,desc:'6x135 bolt pattern (2004-2014) or 6x139.7 (2015+).',amazon:'https://www.amazon.com/s?k=20+inch+wheels+ford+f150+6x135',ebay:'https://www.ebay.com/sch/i.html?_nkw=20+inch+ford+f150+wheels',rockauto:'https://www.rockauto.com/en/partsearch/?query=wheels+20+forged'},
    {id:8,name:'Downpipe Upgrade (EcoBoost)',brand:'MBRP / Kooks',cat:'exhaust',icon:'⬇️',hp:'+20–35 whp',hpNum:28,diff:'Moderate',diffC:'amber',price:480,tune:'Recommended',compat:'warn',badge:'⚠ TUNE RECOMMENDED',pop:75,desc:'Reduces backpressure on 3.5TT. Pairs with tune.',amazon:'https://www.amazon.com/s?k=ford+f150+ecoboost+downpipe',ebay:'https://www.ebay.com/sch/i.html?_nkw=f150+ecoboost+downpipe',rockauto:'https://www.rockauto.com/en/partsearch/?query=downpipe+upgrade+ecoboost'},
  ],

  // ── WRX STI (EJ257) ─────────────────────────────────────
  "EJ257": [
    {id:1,name:'Cold Air Intake / TGV Delete',brand:'Perrin / GrimmSpeed / Cobb',cat:'engine',icon:'🌬️',hp:'+8–15 whp',hpNum:11,diff:'Easy',diffC:'green',price:280,tune:'TGV delete needs tune',compat:'warn',badge:'⚠ TGV NEEDS TUNE',pop:88,desc:'TGV delete is the bigger gain — but requires a tune.',amazon:'https://www.amazon.com/s?k=subaru+wrx+sti+cold+air+intake',ebay:'https://www.ebay.com/sch/i.html?_nkw=subaru+sti+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake+tgv+delete'},
    {id:2,name:'Cobb AccessPort (Stage 1)',brand:'Cobb Tuning',cat:'engine',icon:'💻',hp:'+30–50 whp',hpNum:40,diff:'Software only',diffC:'blue',price:700,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:96,desc:'The essential STI mod. Unlocks full bolt-on potential.',amazon:'https://www.amazon.com/s?k=cobb+accessport+sti',ebay:'https://www.ebay.com/sch/i.html?_nkw=cobb+accessport+wrx+sti',rockauto:'https://www.rockauto.com/en/partsearch/?query=cobb+accessport+stage+1'},
    {id:3,name:'Catback Exhaust',brand:'Invidia / HKS / Tomei',cat:'exhaust',icon:'💨',hp:'+10–18 whp',hpNum:14,diff:'Easy',diffC:'green',price:720,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Deep boxer rumble. Invidia N1 is crowd favorite.',amazon:'https://www.amazon.com/s?k=subaru+sti+catback+exhaust',ebay:'https://www.ebay.com/sch/i.html?_nkw=subaru+sti+catback',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:4,name:'Uppipe Upgrade',brand:'GrimmSpeed / Perrin',cat:'exhaust',icon:'⬇️',hp:'+12–20 whp',hpNum:16,diff:'Moderate',diffC:'amber',price:350,tune:'Recommended',compat:'warn',badge:'⚠ TUNE RECOMMENDED',pop:82,desc:'Removes restrictive OEM cat uppipe. Spool improvement.',amazon:'https://www.amazon.com/s?k=subaru+sti+uppipe',ebay:'https://www.ebay.com/sch/i.html?_nkw=subaru+sti+uppipe',rockauto:'https://www.rockauto.com/en/partsearch/?query=uppipe+upgrade'},
    {id:5,name:'TMIC Upgrade',brand:'Perrin / Cobb / GrimmSpeed',cat:'engine',icon:'❄️',hp:'+15–25 whp',hpNum:20,diff:'Moderate',diffC:'amber',price:580,tune:'Recommended',compat:'ok',badge:'✓ COMPATIBLE',pop:85,desc:'Top-mount intercooler upgrade. Must-do before power mods.',amazon:'https://www.amazon.com/s?k=subaru+sti+intercooler+upgrade',ebay:'https://www.ebay.com/sch/i.html?_nkw=subaru+sti+intercooler',rockauto:'https://www.rockauto.com/en/partsearch/?query=tmic+upgrade'},
    {id:6,name:'Coilover Kit',brand:'Öhlins / BC Racing / Fortune Auto',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1600,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:87,desc:'Essential for WRX/STI track use.',amazon:'https://www.amazon.com/s?k=subaru+sti+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=subaru+sti+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
    {id:7,name:'Turbo Upgrade (VF52/TD06)',brand:'Blobeye / Kartboy / STI',cat:'engine',icon:'🌀',hp:'+80–120 whp',hpNum:100,diff:'Hard',diffC:'red',price:2400,tune:'Required',compat:'req',badge:'FULL BUILD REQ.',pop:70,desc:'VF52 or TD06SL2 swap. Supporting mods essential.',amazon:'https://www.amazon.com/s?k=subaru+sti+turbo+upgrade',ebay:'https://www.ebay.com/sch/i.html?_nkw=subaru+sti+turbo+upgrade',rockauto:'https://www.rockauto.com/en/partsearch/?query=turbo+upgrade+vf52td06'},
  ...
  "Coyote 5.0": [
    {id:1,name:'Cold Air Intake',brand:'Roush / K&N / JLT',cat:'engine',icon:'🌬️',hp:'+10–20 whp',hpNum:15,diff:'Easy',diffC:'green',price:260,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:93,desc:'Direct-fit Coyote V8 intake. JLT is top performer.',amazon:'https://www.amazon.com/s?k=ford+mustang+gt+cold+air+intake+5.0',ebay:'https://www.ebay.com/sch/i.html?_nkw=mustang+gt+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Catback Exhaust',brand:'Borla / Roush / Corsa',cat:'exhaust',icon:'💨',hp:'+15–25 whp',hpNum:20,diff:'Easy',diffC:'green',price:900,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:95,desc:'The Coyote V8 sounds incredible with a good catback.',amazon:'https://www.amazon.com/s?k=ford+mustang+gt+catback+exhaust+5.0',ebay:'https://www.ebay.com/sch/i.html?_nkw=mustang+gt+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:3,name:'Supercharger Kit',brand:'Whipple / Roush / Edelbrock',cat:'engine',icon:'🌀',hp:'+200–350 whp',hpNum:275,diff:'Hard',diffC:'red',price:7500,tune:'Required',compat:'req',badge:'REQUIRES SUPPORTING MODS',pop:82,desc:'Whipple 3.0L is the gold standard. Supporting mods needed.',amazon:'https://www.amazon.com/s?k=ford+mustang+gt+supercharger+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=mustang+gt+supercharger',rockauto:'https://www.rockauto.com/en/partsearch/?query=supercharger+kit'},
    {id:4,name:'Performance Tune (HP Tuners)',brand:'Lund Racing / Brenspeed',cat:'engine',icon:'💻',hp:'+25–40 whp',hpNum:32,diff:'Software only',diffC:'blue',price:450,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Unlocks full bolt-on potential on 93 octane.',amazon:'https://www.amazon.com/s?k=ford+mustang+gt+performance+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=mustang+gt+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+tune+hp+tuners'},
    {id:5,name:'Long Tube Headers',brand:'Kooks / American Racing',cat:'exhaust',icon:'⬇️',hp:'+25–45 whp',hpNum:35,diff:'Hard',diffC:'red',price:1200,tune:'Strongly recommended',compat:'warn',badge:'⚠ TUNE NEEDED',pop:80,desc:'Biggest NA power gain on Coyote. Needs a tune.',amazon:'https://www.amazon.com/s?k=ford+mustang+gt+long+tube+headers',ebay:'https://www.ebay.com/sch/i.html?_nkw=mustang+gt+long+tube+headers',rockauto:'https://www.rockauto.com/en/partsearch/?query=long+tube+headers'},
    {id:6,name:'Coilover Kit',brand:'Öhlins / MagneRide / BMR',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1800,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:85,desc:'Major improvement especially for track days.',amazon:'https://www.amazon.com/s?k=ford+mustang+gt+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=mustang+gt+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
    ...
    {id:8,name:'Forged Wheels 19"',brand:'HRE / Forgeline / Weld',cat:'wheels',icon:'⭕',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:3200,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:78,desc:'5x114.3 bolt pattern. 10.5" rear for max grip.',amazon:'https://www.amazon.com/s?k=ford+mustang+wheels+5x114+19+inch',ebay:'https://www.ebay.com/sch/i.html?_nkw=mustang+wheels+19+inch',rockauto:'https://www.rockauto.com/en/partsearch/?query=forged+wheels+19'},
  ],

  // ── CHEVY CAMARO SS (LT1 V8) ────────────────────────────
  "LT1 V8": [
    {id:1,name:'Cold Air Intake',brand:'Moroso / K&N / Vararam',cat:'engine',icon:'🌬️',hp:'+10–18 whp',hpNum:14,diff:'Easy',diffC:'green',price:260,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Direct-fit LT1 V8 intake. Induction roar upgrade.',amazon:'https://www.amazon.com/s?k=chevy+camaro+ss+cold+air+intake+lt1',ebay:'https://www.ebay.com/sch/i.html?_nkw=camaro+ss+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Catback Exhaust',brand:'Corsa / Borla / Flowmaster',cat:'exhaust',icon:'💨',hp:'+15–22 whp',hpNum:18,diff:'Easy',diffC:'green',price:1000,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:93,desc:'LT1 V8 sounds incredible uncorked. Corsa Sport is king.',amazon:'https://www.amazon.com/s?k=chevy+camaro+ss+catback+exhaust',ebay:'https://www.ebay.com/sch/i.html?_nkw=camaro+ss+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:3,name:'Supercharger Kit',brand:'Magnuson / Edelbrock / ProCharger',cat:'engine',icon:'🌀',hp:'+180–280 whp',hpNum:230,diff:'Hard',diffC:'red',price:7000,tune:'Required',compat:'req',badge:'REQUIRES SUPPORTING MODS',pop:78,desc:'TVS2300 or ProCharger D1SC. 650+ whp capable.',amazon:'https://www.amazon.com/s?k=camaro+ss+supercharger',ebay:'https://www.ebay.com/sch/i.html?_nkw=camaro+ss+supercharger',rockauto:'https://www.rockauto.com/en/partsearch/?query=supercharger+kit'},
    {id:4,name:'Performance Tune (E85/93)',brand:'Lund Racing / Vengeance',cat:'engine',icon:'💻',hp:'+30–45 whp',hpNum:37,diff:'Software only',diffC:'blue',price:500,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'93 oct tune. E85 maps available for big gains.',amazon:'https://www.amazon.com/s?k=camaro+ss+lt1+performance+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=camaro+ss+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+tune+e8593'},
    {id:5,name:'Long Tube Headers',brand:'Kooks / American Racing Headers',cat:'exhaust',icon:'⬇️',hp:'+30–50 whp',hpNum:40,diff:'Hard',diffC:'red',price:1400,tune:'Strongly recommended',compat:'warn',badge:'⚠ TUNE NEEDED',pop:80,desc:'Single biggest NA power move on LT1.',amazon:'https://www.amazon.com/s?k=camaro+ss+long+tube+headers',ebay:'https://www.ebay.com/sch/i.html?_nkw=camaro+ss+long+tube+headers',rockauto:'https://www.rockauto.com/en/partsearch/?query=long+tube+headers'},
    {id:6,name:'Coilover Kit',brand:'Öhlins / KW / Pfadt',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1700,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:83,desc:'Major handling upgrade for track and street.',amazon:'https://www.amazon.com/s?k=chevy+camaro+ss+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=camaro+ss+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
  ],

  // ── DODGE HEMI (Challenger / Charger) ───────────────────
  "HEMI": [
    {id:1,name:'Cold Air Intake',brand:'Mopar / K&N / Airaid',cat:'engine',icon:'🌬️',hp:'+8–15 whp',hpNum:11,diff:'Easy',diffC:'green',price:250,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Adds growl to the HEMI V8. Easy bolt-on.',amazon:'https://www.amazon.com/s?k=dodge+challenger+charger+cold+air+intake+hemi',ebay:'https://www.ebay.com/sch/i.html?_nkw=dodge+challenger+cold+air+intake+hemi',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Catback Exhaust',brand:'Borla / Corsa / MagnaFlow',cat:'exhaust',icon:'💨',hp:'+15–25 whp',hpNum:20,diff:'Easy',diffC:'green',price:950,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:94,desc:'HEMI sounds incredible with a free-flowing exhaust.',amazon:'https://www.amazon.com/s?k=dodge+challenger+catback+exhaust+hemi',ebay:'https://www.ebay.com/sch/i.html?_nkw=dodge+challenger+catback+hemi',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:3,name:'Supercharger Kit (HEMI)',brand:'Magnuson / Procharger / Edelbrock',cat:'engine',icon:'🌀',hp:'+200–350 whp',hpNum:280,diff:'Hard',diffC:'red',price:7500,tune:'Required',compat:'req',badge:'REQUIRES SUPPORTING MODS',pop:80,desc:'TVS2300 or ProCharger. 700+ whp on 392.',amazon:'https://www.amazon.com/s?k=dodge+challenger+392+supercharger',ebay:'https://www.ebay.com/sch/i.html?_nkw=dodge+challenger+supercharger+hemi',rockauto:'https://www.rockauto.com/en/partsearch/?query=supercharger+kit+hemi'},
    {id:4,name:'Performance Tune',brand:'Diablo / Lund / HP Tuners',cat:'engine',icon:'💻',hp:'+25–45 whp',hpNum:35,diff:'Software only',diffC:'blue',price:500,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:86,desc:'Unlocks 5.7 and 6.4 potential. Trans tuning too.',amazon:'https://www.amazon.com/s?k=dodge+challenger+hemi+performance+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=dodge+challenger+tune+hemi',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+tune'},
    {id:5,name:'Long Tube Headers',brand:'Kooks / American Racing',cat:'exhaust',icon:'⬇️',hp:'+30–50 whp',hpNum:40,diff:'Hard',diffC:'red',price:1300,tune:'Strongly recommended',compat:'warn',badge:'⚠ TUNE NEEDED',pop:76,desc:'Best bang for buck on naturally-aspirated HEMI.',amazon:'https://www.amazon.com/s?k=dodge+challenger+long+tube+headers',ebay:'https://www.ebay.com/sch/i.html?_nkw=dodge+challenger+long+tube+headers',rockauto:'https://www.rockauto.com/en/partsearch/?query=long+tube+headers'},
    {id:6,name:'Coilover Kit',brand:'BC Racing / Eibach / KW',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1500,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:78,desc:'Major handling upgrade for the big Mopar.',amazon:'https://www.amazon.com/s?k=dodge+challenger+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=dodge+challenger+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
    {id:7,name:'Widebody Kit',brand:'OEM Widebody / Duraflex',cat:'aero',icon:'💪',hp:'N/A',hpNum:0,diff:'Hard',diffC:'red',price:3800,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:72,desc:'305 rear tires on widebody. Aggressive stance.',amazon:'https://www.amazon.com/s?k=dodge+challenger+widebody+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=dodge+challenger+widebody',rockauto:'https://www.rockauto.com/en/partsearch/?query=widebody+kit'},
  ],

  // ── BMW S55 / S58 ─────────────────────────────────────
  "S55 / S58": [
    {id:1,name:'Cold Air Intake',brand:'Eventuri / MST / aFe',cat:'engine',icon:'🌬️',hp:'+10–18 whp',hpNum:14,diff:'Easy',diffC:'green',price:580,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Carbon fibre options from Eventuri. S58 responds well.',amazon:'https://www.amazon.com/s?k=bmw+m3+m4+s58+cold+air+intake',ebay:'https://www.ebay.com/sch/i.html?_nkw=bmw+m3+m4+s58+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'MHD Stage 1 / 2 Tune',brand:'MHD / Bootmod3',cat:'engine',icon:'💻',hp:'+60–90 whp',hpNum:75,diff:'Software only',diffC:'blue',price:200,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:95,desc:'Best value BMW tune. Stage 2 on 93 or E30.',amazon:'https://www.amazon.com/s?k=bmw+m4+mhd+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=bmw+m4+ecu+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=mhd+stage+1+2+tune'},
    {id:3,name:'Downpipe Upgrade',brand:'Akrapovič / Wagner / Dinan',cat:'exhaust',icon:'⬇️',hp:'+25–40 whp',hpNum:32,diff:'Moderate',diffC:'amber',price:1400,tune:'Strongly recommended',compat:'warn',badge:'⚠ TUNE NEEDED',pop:85,desc:'Major spool improvement and power gains.',amazon:'https://www.amazon.com/s?k=bmw+m3+m4+downpipe',ebay:'https://www.ebay.com/sch/i.html?_nkw=bmw+m4+downpipe',rockauto:'https://www.rockauto.com/en/partsearch/?query=downpipe+upgrade'},
    {id:4,name:'Catback Exhaust',brand:'Akrapovič / Remus / FI',cat:'exhaust',icon:'💨',hp:'+10–18 whp',hpNum:14,diff:'Easy',diffC:'green',price:2200,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Sound upgrade and mild power gains. Akrapovič is king.',amazon:'https://www.amazon.com/s?k=bmw+m3+m4+catback+exhaust',ebay:'https://www.ebay.com/sch/i.html?_nkw=bmw+m4+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:5,name:'Coilover Kit',brand:'KW V3 / BC Racing / Öhlins',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:2200,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:84,desc:'KW V3 is the benchmark for M3/M4 street/track.',amazon:'https://www.amazon.com/s?k=bmw+m3+m4+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=bmw+m4+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
    {id:6,name:'Charge Pipe Upgrade',brand:'Burger Motorsports / Mishimoto',cat:'engine',icon:'🔧',hp:'+5–10 whp',hpNum:7,diff:'Easy',diffC:'green',price:280,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:80,desc:'Prevents plastic OEM pipe splitting under boost.',amazon:'https://www.amazon.com/s?k=bmw+m3+m4+charge+pipe',ebay:'https://www.ebay.com/sch/i.html?_nkw=bmw+m4+charge+pipe',rockauto:'https://www.rockauto.com/en/partsearch/?query=charge+pipe+upgrade'},
  ],

  // ── VW EA888 (Golf R / GTI) ──────────────────────────────
  "EA888": [
    {id:1,name:'Cold Air Intake',brand:'Eventuri / APR / Revo',cat:'engine',icon:'🌬️',hp:'+8–15 whp',hpNum:11,diff:'Easy',diffC:'green',price:380,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:86,desc:'Direct fit EA888. APR is most popular choice.',amazon:'https://www.amazon.com/s?k=vw+golf+r+gti+cold+air+intake',ebay:'https://www.ebay.com/sch/i.html?_nkw=golf+r+gti+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Stage 1 ECU Tune',brand:'APR / Unitronic / Revo',cat:'engine',icon:'💻',hp:'+60–80 whp',hpNum:70,diff:'Software only',diffC:'blue',price:700,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:96,desc:'Biggest bang for buck on EA888. 91/93 oct maps.',amazon:'https://www.amazon.com/s?k=vw+golf+r+stage+1+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=golf+r+ecu+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=stage+1+ecu+tune'},
    {id:3,name:'Downpipe (Hi-Flow)',brand:'MBRP / Milltek / Unitronic',cat:'exhaust',icon:'⬇️',hp:'+20–35 whp',hpNum:28,diff:'Moderate',diffC:'amber',price:480,tune:'Required for Stage 2',compat:'warn',badge:'⚠ TUNE NEEDED (Stage 2)',pop:84,desc:'Required for Stage 2 tune. Major gains with DSG tune.',amazon:'https://www.amazon.com/s?k=vw+golf+r+downpipe',ebay:'https://www.ebay.com/sch/i.html?_nkw=golf+r+downpipe',rockauto:'https://www.rockauto.com/en/partsearch/?query=downpipe+hiflow'},
    {id:4,name:'Catback Exhaust',brand:'Milltek / Remus / APR',cat:'exhaust',icon:'💨',hp:'+8–14 whp',hpNum:11,diff:'Easy',diffC:'green',price:1100,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'GTI/R sound upgrade. Resonated or non-res options.',amazon:'https://www.amazon.com/s?k=vw+golf+r+catback+exhaust',ebay:'https://www.ebay.com/sch/i.html?_nkw=golf+r+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:5,name:'Intercooler Upgrade',brand:'Wagner / APR / Forge',cat:'engine',icon:'❄️',hp:'+15–25 whp',hpNum:20,diff:'Moderate',diffC:'amber',price:650,tune:'Recommended',compat:'ok',badge:'✓ COMPATIBLE',pop:80,desc:'OEM FMIC is undersized. Wagner is the benchmark.',amazon:'https://www.amazon.com/s?k=vw+golf+r+intercooler',ebay:'https://www.ebay.com/sch/i.html?_nkw=golf+r+intercooler+wagner',rockauto:'https://www.rockauto.com/en/partsearch/?query=intercooler+upgrade'},
    {id:6,name:'Coilover Kit',brand:'BC Racing / KW V3 / Bilstein',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1400,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:84,desc:'Transforms the Golf platform for track and street.',amazon:'https://www.amazon.com/s?k=vw+golf+r+gti+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=golf+r+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
  ],

  // ── GENERIC TRUCK (for 4Runner, Frontier, Colorado, etc.) ─
  "1GR-FE": [
    {id:1,name:'Suspension Lift Kit (2–3")',brand:'Bilstein / Old Man Emu / Rough Country',cat:'suspension',icon:'⬆️',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:700,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:95,desc:'Most popular 4Runner mod. 2.5"+ needed for 33" tires.',amazon:'https://www.amazon.com/s?k=toyota+4runner+lift+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+4runner+lift+kit',rockauto:'https://www.rockauto.com/en/partsearch/?query=suspension+lift+kit+23'},
    {id:2,name:'All-Terrain Tires (33–35")',brand:'BFG KO2 / Falken WildPeak',cat:'wheels',icon:'🏁',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1200,tune:'Not required',compat:'warn',badge:'⚠ CHECK LIFT HEIGHT',pop:93,desc:'BFG KO2 is #1 choice. 33s on 2", 35s on 4"+.',amazon:'https://www.amazon.com/s?k=33+inch+all+terrain+tires+4runner',ebay:'https://www.ebay.com/sch/i.html?_nkw=4runner+all+terrain+tires',rockauto:'https://www.rockauto.com/en/partsearch/?query=allterrain+tires+3335'},
    {id:3,name:'Skid Plates',brand:'NNDA / SCS / ARB',cat:'aero',icon:'🛡️',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:350,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Engine, transfer case, rear diff protection.',amazon:'https://www.amazon.com/s?k=toyota+4runner+skid+plates',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+4runner+skid+plate',rockauto:'https://www.rockauto.com/en/partsearch/?query=skid+plates'},
    {id:4,name:'Cold Air Intake',brand:'K&N / AEM',cat:'engine',icon:'🌬️',hp:'+5–10 whp',hpNum:7,diff:'Easy',diffC:'green',price:200,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:80,desc:'Minor gains on 4.0 V6 NA engine.',amazon:'https://www.amazon.com/s?k=toyota+4runner+cold+air+intake',ebay:'https://www.ebay.com/sch/i.html?_nkw=toyota+4runner+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:5,name:'Aftermarket Wheels',brand:'Method / Black Rhino / Fuel',cat:'wheels',icon:'⭕',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1600,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'6x139.7 bolt pattern. Wide variety of offsets.',amazon:'https://www.amazon.com/s?k=toyota+4runner+wheels+6x139',ebay:'https://www.ebay.com/sch/i.html?_nkw=4runner+wheels+6x139',rockauto:'https://www.rockauto.com/en/partsearch/?query=aftermarket+wheels'},
    {id:6,name:'ARB Air Locker',brand:'ARB',cat:'suspension',icon:'🔒',hp:'N/A',hpNum:0,diff:'Hard',diffC:'red',price:850,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:74,desc:'Essential for serious off-road. Front or rear.',amazon:'https://www.amazon.com/s?k=arb+air+locker+4runner',ebay:'https://www.ebay.com/sch/i.html?_nkw=arb+locker+4runner',rockauto:'https://www.rockauto.com/en/partsearch/?query=arb+air+locker'},
  ],

  // ── JEEP WRANGLER ────────────────────────────────────────
  "Pentastar / HEMI": [
    {id:1,name:'Suspension Lift Kit (3.5")',brand:'Rubicon Express / Rough Country / Fox',cat:'suspension',icon:'⬆️',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1200,tune:'Alignment + CV angles',compat:'ok',badge:'✓ COMPATIBLE',pop:97,desc:'Most common Wrangler mod. Fits 35" tires.',amazon:'https://www.amazon.com/s?k=jeep+wrangler+jl+lift+kit+3.5+inch',ebay:'https://www.ebay.com/sch/i.html?_nkw=jeep+wrangler+jl+lift+kit',rockauto:'https://www.rockauto.com/en/partsearch/?query=suspension+lift+kit+35'},
    {id:2,name:'35" All-Terrain / Mud Tires',brand:'BFG KO2 / Mickey Thompson / Nitto',cat:'wheels',icon:'🏁',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1400,tune:'Re-gear recommended',compat:'warn',badge:'⚠ RE-GEAR RECOMMENDED',pop:95,desc:'35s on Wrangler. Re-gear to 4.56 for best performance.',amazon:'https://www.amazon.com/s?k=35+inch+jeep+wrangler+tires',ebay:'https://www.ebay.com/sch/i.html?_nkw=35+inch+wrangler+tires',rockauto:'https://www.rockauto.com/en/partsearch/?query=35+allterrain+mud+tires'},
    {id:3,name:'Axle Re-Gear (4.10 / 4.56)',brand:'G2 Axle / Yukon Gear',cat:'suspension',icon:'⚙️',hp:'N/A',hpNum:0,diff:'Hard',diffC:'red',price:1600,tune:'Not required',compat:'req',badge:'REQUIRED WITH 35"+ TIRES',pop:86,desc:'Required with 35"+ tires. Restores performance and MPG.',amazon:'https://www.amazon.com/s?k=jeep+wrangler+axle+re-gear+4.56',ebay:'https://www.ebay.com/sch/i.html?_nkw=jeep+wrangler+re+gear+4.56',rockauto:'https://www.rockauto.com/en/partsearch/?query=axle+regear+410+456'},
    {id:4,name:'Front / Rear Bumpers',brand:'Poison Spyder / LoD / Smittybilt',cat:'aero',icon:'💥',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:900,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Steel bumpers with recovery points. Better approach angle.',amazon:'https://www.amazon.com/s?k=jeep+wrangler+jl+front+bumper',ebay:'https://www.ebay.com/sch/i.html?_nkw=jeep+wrangler+jl+bumper',rockauto:'https://www.rockauto.com/en/partsearch/?query=front+rear+bumpers'},
    {id:5,name:'Skid Plate Set',brand:'Rugged Ridge / GenRight / Artec',cat:'aero',icon:'🛡️',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:480,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Full belly protection. Engine, fuel tank, transfer case.',amazon:'https://www.amazon.com/s?k=jeep+wrangler+jl+skid+plates',ebay:'https://www.ebay.com/sch/i.html?_nkw=jeep+wrangler+jl+skid+plates',rockauto:'https://www.rockauto.com/en/partsearch/?query=skid+plate+set'},
    {id:6,name:'Cold Air Intake',brand:'K&N / aFe / Rugged Ridge',cat:'engine',icon:'🌬️',hp:'+8–15 whp',hpNum:11,diff:'Easy',diffC:'green',price:260,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:78,desc:'Noticeable on the 3.6 Pentastar. 2.0T also benefits.',amazon:'https://www.amazon.com/s?k=jeep+wrangler+cold+air+intake+pentastar',ebay:'https://www.ebay.com/sch/i.html?_nkw=jeep+wrangler+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:7,name:'ARB Differential Locker',brand:'ARB',cat:'suspension',icon:'🔒',hp:'N/A',hpNum:0,diff:'Hard',diffC:'red',price:900,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:82,desc:'Air locker front + rear. Transforms off-road capability.',amazon:'https://www.amazon.com/s?k=arb+air+locker+jeep+wrangler',ebay:'https://www.ebay.com/sch/i.html?_nkw=arb+locker+jeep+wrangler',rockauto:'https://www.rockauto.com/en/partsearch/?query=arb+differential+locker'},
    {id:8,name:'Winch (12,000 lb)',brand:'Warn / Smittybilt / Badland',cat:'aero',icon:'🪝',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:650,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:84,desc:'12K lb synthetic rope winch. Essential recovery tool.',amazon:'https://www.amazon.com/s?k=jeep+wrangler+winch+12000',ebay:'https://www.ebay.com/sch/i.html?_nkw=jeep+wrangler+winch+12000',rockauto:'https://www.rockauto.com/en/partsearch/?query=winch+12000+lb'},
  ],

  // ── GENERIC K20/K24 (Civic Type R, Integra) ─────────────
  "K20C1": [
    {id:1,name:'Cold Air Intake',brand:'Injen / Mugen / Mishimoto',cat:'engine',icon:'🌬️',hp:'+8–14 whp',hpNum:11,diff:'Easy',diffC:'green',price:280,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Type R K20C1 intake. 2–3 hr DIY.',amazon:'https://www.amazon.com/s?k=honda+civic+type+r+cold+air+intake',ebay:'https://www.ebay.com/sch/i.html?_nkw=civic+type+r+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'ECU Tune (Hondata)',brand:'Hondata / KTuner',cat:'engine',icon:'💻',hp:'+30–50 whp',hpNum:40,diff:'Software only',diffC:'blue',price:500,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:94,desc:'Hondata FlashPro is THE K20C1 tune platform.',amazon:'https://www.amazon.com/s?k=hondata+flashpro+civic+type+r',ebay:'https://www.ebay.com/sch/i.html?_nkw=hondata+flashpro+civic+type+r',rockauto:'https://www.rockauto.com/en/partsearch/?query=ecu+tune+hondata'},
    {id:3,name:'Downpipe Upgrade',brand:'Full Race / Skunk2 / GReddy',cat:'exhaust',icon:'⬇️',hp:'+18–28 whp',hpNum:23,diff:'Moderate',diffC:'amber',price:550,tune:'Required for Stage 2',compat:'warn',badge:'⚠ TUNE NEEDED',pop:82,desc:'High-flow DP unlocks full turbo potential.',amazon:'https://www.amazon.com/s?k=honda+civic+type+r+downpipe',ebay:'https://www.ebay.com/sch/i.html?_nkw=civic+type+r+downpipe',rockauto:'https://www.rockauto.com/en/partsearch/?query=downpipe+upgrade'},
    {id:4,name:'Catback Exhaust',brand:'Mugen / Invidia / HKS',cat:'exhaust',icon:'💨',hp:'+10–16 whp',hpNum:13,diff:'Easy',diffC:'green',price:850,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'VTEC scream + turbo spool. Mugen is iconic.',amazon:'https://www.amazon.com/s?k=honda+civic+type+r+catback',ebay:'https://www.ebay.com/sch/i.html?_nkw=civic+type+r+catback',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:5,name:'Coilover Kit',brand:'Tein / BC Racing / KW V3',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1400,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:86,desc:'Type R is already great — coils make it sublime.',amazon:'https://www.amazon.com/s?k=honda+civic+type+r+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=civic+type+r+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
    {id:6,name:'Intercooler Upgrade',brand:'Mishimoto / Kraftwerks',cat:'engine',icon:'❄️',hp:'+12–22 whp',hpNum:17,diff:'Moderate',diffC:'amber',price:580,tune:'Recommended',compat:'ok',badge:'✓ COMPATIBLE',pop:78,desc:'OEM FMIC is limiting. Required for Stage 2+.',amazon:'https://www.amazon.com/s?k=honda+civic+type+r+intercooler',ebay:'https://www.ebay.com/sch/i.html?_nkw=civic+type+r+intercooler',rockauto:'https://www.rockauto.com/en/partsearch/?query=intercooler+upgrade'},
  ],

  // ── FA24 (GR86 / BRZ) ───────────────────────────────────
  "FA24": [
    {id:1,name:'Cold Air Intake',brand:'Cusco / GReddy / Injen',cat:'engine',icon:'🌬️',hp:'+5–10 whp',hpNum:7,diff:'Easy',diffC:'green',price:240,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:82,desc:'Modest gains on NA FA24. Better induction sound.',amazon:'https://www.amazon.com/s?k=toyota+gr86+subaru+brz+cold+air+intake',ebay:'https://www.ebay.com/sch/i.html?_nkw=gr86+brz+cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
    {id:2,name:'Supercharger Kit',brand:'Kraftwerks / Jackson Racing',cat:'engine',icon:'🌀',hp:'+80–120 whp',hpNum:100,diff:'Hard',diffC:'red',price:4500,tune:'Required',compat:'req',badge:'FULL INSTALL REQ.',pop:78,desc:'Best power option for NA FA24. Rotrex or Harrop blowers.',amazon:'https://www.amazon.com/s?k=toyota+gr86+supercharger+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=gr86+brz+supercharger',rockauto:'https://www.rockauto.com/en/partsearch/?query=supercharger+kit'},
    {id:3,name:'Catback Exhaust',brand:'HKS / GReddy / Tomei',cat:'exhaust',icon:'💨',hp:'+8–14 whp',hpNum:11,diff:'Easy',diffC:'green',price:750,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Boxer sound is addicting. HKS Hi-Power is classic.',amazon:'https://www.amazon.com/s?k=toyota+gr86+subaru+brz+catback',ebay:'https://www.ebay.com/sch/i.html?_nkw=gr86+brz+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=catback+exhaust'},
    {id:4,name:'Coilover Kit',brand:'Öhlins / BC Racing / Fortune Auto',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1500,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'86/BRZ is a handling platform first.',amazon:'https://www.amazon.com/s?k=toyota+gr86+subaru+brz+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=gr86+brz+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
    {id:5,name:'Hondata / EcuTek Tune',brand:'Hondata / EcuTek',cat:'engine',icon:'💻',hp:'+15–25 whp',hpNum:20,diff:'Software only',diffC:'blue',price:600,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:80,desc:'EcuTek is dominant platform for 86/BRZ.',amazon:'https://www.amazon.com/s?k=subaru+brz+ecutek+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=gr86+brz+ecutek',rockauto:'https://www.rockauto.com/en/partsearch/?query=hondata+ecutek+tune'},
  ],

  // ── GT-R (VR38DETT) ──────────────────────────────────────
  "VR38DETT": [
    {id:1,name:'Intake Plenum Upgrade',brand:'Cobb / HKS / AMS',cat:'engine',icon:'🌬️',hp:'+20–35 whp',hpNum:27,diff:'Moderate',diffC:'amber',price:1200,tune:'Strongly recommended',compat:'warn',badge:'⚠ TUNE RECOMMENDED',pop:82,desc:'Significant gains on VR38. AMS billet is top pick.',amazon:'https://www.amazon.com/s?k=nissan+gtr+intake+plenum',ebay:'https://www.ebay.com/sch/i.html?_nkw=nissan+gtr+intake+plenum',rockauto:'https://www.rockauto.com/en/partsearch/?query=intake+plenum+upgrade'},
    {id:2,name:'Cobb AccessPort (VR38)',brand:'Cobb Tuning',cat:'engine',icon:'💻',hp:'+50–80 whp',hpNum:65,diff:'Software only',diffC:'blue',price:800,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Base stage 1 tune. Massive safe power gains.',amazon:'https://www.amazon.com/s?k=nissan+gtr+cobb+accessport',ebay:'https://www.ebay.com/sch/i.html?_nkw=nissan+gtr+cobb+accessport',rockauto:'https://www.rockauto.com/en/partsearch/?query=cobb+accessport+vr38'},
    {id:3,name:'Turbo Upgrade (GT-R)',brand:'AMS / Forced Performance',cat:'engine',icon:'🌀',hp:'+200–400 whp',hpNum:300,diff:'Hard',diffC:'red',price:8000,tune:'Required',compat:'req',badge:'FULL BUILD REQ.',pop:70,desc:'Alpha series or Forced Performance kits. 800+ whp capable.',amazon:'https://www.amazon.com/s?k=nissan+gtr+turbo+upgrade',ebay:'https://www.ebay.com/sch/i.html?_nkw=nissan+gtr+turbo+upgrade',rockauto:'https://www.rockauto.com/en/partsearch/?query=turbo+upgrade+gtr'},
    {id:4,name:'Exhaust Upgrade',brand:'Akrapovič / HKS / Tomei',cat:'exhaust',icon:'💨',hp:'+15–25 whp',hpNum:20,diff:'Moderate',diffC:'amber',price:3500,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:85,desc:'VR38 sound is iconic. Titanium catback options.',amazon:'https://www.amazon.com/s?k=nissan+gtr+exhaust',ebay:'https://www.ebay.com/sch/i.html?_nkw=nissan+gtr+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=exhaust+upgrade'},
    {id:5,name:'Coilover Kit',brand:'Öhlins / KW / BC Racing',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:2400,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:78,desc:'GT-R multi-link suspension responds well to good coils.',amazon:'https://www.amazon.com/s?k=nissan+gtr+coilovers',ebay:'https://www.ebay.com/sch/i.html?_nkw=nissan+gtr+coilovers',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
  ],
};

// ── FALLBACK parts for anything not explicitly mapped ────────
PARTS_BY_PLATFORM["default"] = [
  {id:1,name:'Cold Air Intake',brand:'K&N / AEM / Injen',cat:'engine',icon:'🌬️',hp:'+5–12 whp',hpNum:8,diff:'Easy',diffC:'green',price:220,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:90,desc:'Universal short ram or cold air intake. Check fitment.',amazon:'https://www.amazon.com/s?k=cold+air+intake',ebay:'https://www.ebay.com/sch/i.html?_nkw=cold+air+intake',rockauto:'https://www.rockauto.com/en/partsearch/?query=cold+air+intake'},
  {id:2,name:'Performance Exhaust',brand:'MagnaFlow / Borla / Flowmaster',cat:'exhaust',icon:'💨',hp:'+10–20 whp',hpNum:15,diff:'Easy',diffC:'green',price:600,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:88,desc:'Cat-back or axle-back. Check your specific fitment.',amazon:'https://www.amazon.com/s?k=performance+catback+exhaust',ebay:'https://www.ebay.com/sch/i.html?_nkw=performance+catback+exhaust',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+exhaust'},
  {id:3,name:'Performance Tune',brand:'DiabloSport / HP Tuners / SCT',cat:'engine',icon:'💻',hp:'+20–40 whp',hpNum:30,diff:'Software only',diffC:'blue',price:450,tune:'IS the tune',compat:'ok',badge:'✓ COMPATIBLE',pop:85,desc:'Custom tune for your platform. Huge value mod.',amazon:'https://www.amazon.com/s?k=performance+ecu+tune',ebay:'https://www.ebay.com/sch/i.html?_nkw=performance+ecu+tune',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+tune'},
  {id:4,name:'Coilover Kit',brand:'BC Racing / KW / Eibach',cat:'suspension',icon:'🔩',hp:'N/A',hpNum:0,diff:'Moderate',diffC:'amber',price:1200,tune:'Alignment required',compat:'ok',badge:'✓ COMPATIBLE',pop:84,desc:'Height + damper adjustability. Alignment after install.',amazon:'https://www.amazon.com/s?k=coilover+kit',ebay:'https://www.ebay.com/sch/i.html?_nkw=coilover+kit',rockauto:'https://www.rockauto.com/en/partsearch/?query=coilover+kit'},
  {id:5,name:'Performance Brake Pads',brand:'Hawk / EBC / StopTech',cat:'brakes',icon:'🔴',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:120,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:80,desc:'Improved bite and fade resistance. Easy DIY.',amazon:'https://www.amazon.com/s?k=performance+brake+pads',ebay:'https://www.ebay.com/sch/i.html?_nkw=performance+brake+pads',rockauto:'https://www.rockauto.com/en/partsearch/?query=performance+brake+pads'},
  {id:6,name:'Aftermarket Wheels',brand:'Volk / Method / HRE',cat:'wheels',icon:'⭕',hp:'N/A',hpNum:0,diff:'Easy',diffC:'green',price:1400,tune:'Not required',compat:'ok',badge:'✓ COMPATIBLE',pop:86,desc:'Check bolt pattern and offset before ordering.',amazon:'https://www.amazon.com/s?k=aftermarket+wheels',ebay:'https://www.ebay.com/sch/i.html?_nkw=aftermarket+wheels',rockauto:'https://www.rockauto.com/en/partsearch/?query=aftermarket+wheels'},
];
